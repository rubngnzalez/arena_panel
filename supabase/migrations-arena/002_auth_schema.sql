...
CREATE OR REPLACE FUNCTION arena_panel.handle_new_user()
RETURNS TRIGGER AS $$
BEGIN
  IF NEW.raw_user_meta_data->>'app' = 'arena_panel' THEN
  INSERT INTO arena_panel.perfiles_usuario (id, nombre, rol)
  VALUES (
    NEW.id,
...
CREATE TRIGGER on_auth_user_created
  ...
  FOR EACH ROW
  EXECUTE FUNCTION arena_panel.handle_new_user();
